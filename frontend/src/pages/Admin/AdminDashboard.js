        ...
        <>
          ...
          <div className={`rounded-lg shadow ${isDark ? 'bg-dark-900 border border-dark-700' : 'bg-white'}`}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 p-6">
              ...
              <button className={`flex items-center p-4 border-2 rounded-lg transition-all duration-300 ${
                isDark 
                  ? 'border-dark-700 hover:border-gold-500 hover:shadow-lg hover:shadow-gold-500/20 bg-dark-800' 
                  : 'border-gray-200 hover:border-primary-300 hover:bg-primary-50'
              }`}>
                ...
                <div className="ml-3">
                  ...
                  <p className={`text-sm ${isDark ? 'text-gold-300' : 'text-gray-500'}`}>System configuration</p>
                </div>
              </button>
            </div>
          </div>
